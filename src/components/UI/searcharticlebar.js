...
class SearchArticleBar extends React.Component {
  ...
  render() {
    ...
    var articleTitle = selectedSearchArticle.category + ' > ' + 
            selectedSearchArticle.source + ' > ' + selectedSearchArticle.headline;

    var shareUrl = "";
    if (typeof window !== 'undefined') {
      shareUrl = window.location.protocol + '//' + window.location.host;
      if (selectedSearchArticle.type === "Reddit") {
        shareUrl += '/reddit/' + selectedSearchArticle.objectID;
      } else {
        shareUrl += '/news/' + selectedSearchArticle.objectID;
      }
    }     
    ...
    return (
      <div className={classes.root}>
        <AppBar className={classes.appbar}>
          <Toolbar>
            <Link className={classes.linkitem} to={ROUTES.SEARCH_RESULT}>
            ...
            <div className={classes.toolbox}>
              ...
              <Fab aria-label="share" color="err" size="small" className={classes.share} onClick={this.clickShareButton}>
                <ShareIcon />
              </Fab>
            </div>
          </Toolbar>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(SearchArticleBar));
